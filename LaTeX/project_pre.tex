...
\begin{frame}[fragile]{Smart Mini-refrigerator}
	...
	\begin{figure}
		\begin{minipage}[b]{0.4\linewidth}
			\includegraphics[width = 1.0\linewidth]{images/fridge1}
			\caption{Front view}
		\end{minipage}
		\begin{minipage}[b]{0.4\linewidth}
...
\section{Improvements}
{
	\begin{frame}{What could we improve?}
		\begin{itemize}[<+- | alert@+>]
			\item Reduce the volume of the fridge
...
\section{Conclusion}
{
	...
	\begin{itemize}[<+- | alert@+>]
		\item The mini-fridge project combined both hardware and software skills
		\item Utilized more than just Electrical and Electronics knowledge
		\item The result performance is satisfactory: the volume is a little large
	\end{itemize}
\end{frame}
...
\begin{center}
	\color{blue}
	\bfseries{\Huge Thanks for your listening\\~\\Questions?}
\end{center}

...

{
	\begin{frame}
		...
		\begin{center}
			\animategraphics[autoplay,loop,width=0.8\linewidth]{12}{images/peltcool/peltcool-}{0}{61}
		\end{center}
	\end{frame}
}
{
		...
		\begin{figure}[h!]
			\begin{minipage}[b]{0.4\linewidth}
				\begin{center}
					...
					\caption{Single Coil Magnetic Latching SPDT Relay}
				\end{center}
			\end{minipage}
			\begin{minipage}[b]{0.4\linewidth}
				\begin{center}
					\includegraphics[width=0.6\linewidth]{images/relay_schem}
					\caption{Relay schematic diagram}
			\end{center}
			\end{minipage}
		\end{figure}
	\end{frame}
...
}
{
	\begin{frame}{Arduino Code}
		\lstinputlisting[language = C++, lastline = 17]{code/F1VTS29IVO5D4XS.ino}
	
	\end{frame}
}
{
	\begin{frame}{Arduino Code}
		\lstinputlisting[language = C++, firstline = 20]{code/F1VTS29IVO5D4XS.ino}
